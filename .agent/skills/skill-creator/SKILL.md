...
license: Apache-2.0
metadata:
  author: gentleman-programming & Pablo Lozano
  version: "1.0"
...
| `license` | Yes | Look at the license of the project (LICENSE.md) or MIT if not found |
| `metadata.author` | Yes | `Pablo Lozano` |
